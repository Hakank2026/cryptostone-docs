# 05\_디지털\_보석\_자산의\_기본\_개념

CryptoStone은 하나의 STONE Token, 12개의 보석 마이닝 풀, 하나의 Gem NFT 컨트랙트로 구성된다.

| 구성 요소                    | 역할                              |
| ------------------------ | ------------------------------- |
| STONE Token              | 디지털 광산에 참여하기 위한 단일 마이닝 자원       |
| 12 Gemstone Mining Pools | 각 탄생석을 채굴하는 독립 디지털 광산           |
...
STONE은 보석 그 자체가 아니다. STONE은 디지털 광산에 참여하기 위한 마이닝 파워의 원천이다. 사용자는 STONE을 원하는 보석 마이닝 풀에 스테이킹함으로써 마이닝 파워를 획득하고, 시간이 지남에 따라 PoM을 누적한다.
...
| ----------- | --------------------------------- |
| 광산          | Gemstone Mining Pool              |
| 채굴 장비 및 에너지 | STONE Token                       |
