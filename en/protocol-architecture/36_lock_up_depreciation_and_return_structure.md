...
If the amount of STONX staked by user _i_ is _s_<sub>_i_</sub>, and the depreciation rate according to the lock-up period is _δ_<sub>_i_</sub>, then the amount of STONX burned at maturity (_M_<sub>_i_</sub>) is defined as follows.

$$
M_i = s_i \times \delta_i
$$

The amount of STONX returned (_R_<sub>_i_</sub>) is as follows.
