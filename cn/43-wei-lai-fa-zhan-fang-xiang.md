...
CryptoStone 初期最好使用 EVM 兼容智能合约网络作为 Launch Network，并以 STONE Token、Gem NFT、Mining Pool Contract 结构开始。在这一阶段，应重点验证协议核心：质押、Mining Power 计算、PoM 累积、各宝石减半、宝石属性生成以及 Gem NFT 发行结构。
...
长期来看，CryptoStone 可以从单纯的智能合约项目扩展为专用 Appchain 或 Mainnet。在这种情况下，STONE 可以从单纯挖矿代币发展为网络 gas token 或原生资产，Gem NFT 则可以成为 CryptoStone 网络的基础数字资产。
